...
class AlienInvasion:
	...
	def __init__(self):
		...
		pygame.display.set_caption("Imperial Invasion")
	...
	def _check_keyup_events(self, event):
		"""Respond to letting go of a key"""
		if event.key == pygame.K_d:
	...
	def _check_play_button(self, mouse_pos):
		...
		if button_clicked and not self.stats.game_active:
			self.settings.initialilze_dynamic_settings()
	...
	def _check_bullet_alien_collisions(self):
		...
		if not self.aliens:
			# Destroy exisiting bullets and make a new fleet
			self.bullets.empty()
			self._create_fleet()
	...
	def _create_fleet(self):
		...
		number_aliens_x = 7
		# was number_aliens_x = available_space_x // (2 * alien_width)
	...
	def _check_fleet_edges(self):
		"""Respond if the aliens reach the edge of the screen"""
